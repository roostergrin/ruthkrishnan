<?php
/**
 * Template Name: what costs how much where in san francisco
 * @package WordPress
...
<div class="page-custom-map-blog-post">
        ...
        if ( have_posts() ) :
          while ( have_posts() ) : the_post(); ?>
            ...
            <div class="post-blog__content">
              <?php echo get_field('blog-post-pt-1'); ?>
              <?php echo get_field('blog-post-pt-2'); ?>
            </div>
