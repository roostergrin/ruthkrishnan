  ...
  allSlides.forEach(slide => {
    ...
    if(slide.HJICondoMonthly || slide.HJISingleMonthly){
      if (!slide.HJISingleMonthly.result.measurements.listPrice.median) {
        ...
        slide.elem.querySelector('[id^="single-median-price-display-"]').innerHTML = USDFormatterNoDec.format(slide.HJISingleMonthly.result.measurements.listPrice.median) 
        slide.elem.querySelector('[id^="single-sq-ft-price-display-"]').innerHTML = USDFormatterDec.format(slide.HJISingleMonthly.result.measurements.listPrice.median /slide.HJISingleMonthly.result.measurements.size.median) 
      }
