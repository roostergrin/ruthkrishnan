export const sliderAgent = () => {
  const memberInfoSlides = Array.from(document.querySelectorAll('.slider-agent__member-slide')),
  ...
  const resizeBackgroundHeight = () => {
    const background = document.querySelector('.slider-agent__background'),
  ...
  const changeImageSlide = (pos) => {
    const slideWrapper = document.querySelector('.slider-agent__images');
    if (!slideWrapper) {
      return;
    }
  ...
  const setInfoHeight = () => {
    const memberInfoContainer = document.querySelector('.slider-agent__members-container'),
  ...
  const resetImageSlide = () => {
    const currSlide = document.querySelector('.slider-agent__images-slide--active');
  ...
  const sliderContainer = document.querySelector('.slider-agent__images');
