...
/***/ "./src/scripts/resources/slider-agent.js":
/*!***********************************************!*\
  !*** ./src/scripts/resources/slider-agent.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "sliderAgent": () => (/* binding */ sliderAgent)
/* harmony export */ });
var sliderAgent = function sliderAgent() {
  var memberInfoSlides = Array.from(document.querySelectorAll('.slider-agent__member-slide')),
      imageSlides = Array.from(document.querySelectorAll('.slider-agent__images-slide')),
  ...
  var resizeBackgroundHeight = function resizeBackgroundHeight() {
    var background = document.querySelector('.slider-agent__background'),
        introSection = document.querySelector('.slider-agent__intro'),
        imagesContainer = document.querySelector('.slider-agent__images');
  ...
  var changeImageSlide = function changeImageSlide(pos) {
    var slideWrapper = document.querySelector('.slider-agent__images');
    ...
    imagesArr.forEach(function (slide) {
      if (slide.position === pos) {
        slide.elem.classList.add('slider-agent__images-slide--active');
      } else {
        slide.elem.classList.remove('slider-agent__images-slide--active');
      }
    });
  };
  ...
  var setInfoHeight = function setInfoHeight() {
    var memberInfoContainer = document.querySelector('.slider-agent__members-container'),
        activeSlide = document.querySelector('.slider-agent__member-slide--active');
  ...
  var changeInfoSlide = function changeInfoSlide(pos) {
    memberInfoSlides.forEach(function (slide) {
      if (+slide.dataset.index === pos + 1) {
        slide.classList.add('slider-agent__member-slide--active');
      } else {
        slide.classList.remove('slider-agent__member-slide--active');
      }
    });
    setInfoHeight();
  };
  ...
  var resetImageSlide = function resetImageSlide() {
    var currSlide = document.querySelector('.slider-agent__images-slide--active');
  ...
  var sliderContainer = document.querySelector('.slider-agent__images');
...
/* harmony import */ var _resources_slider_agent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../resources/slider-agent */ "./src/scripts/resources/slider-agent.js");




document.addEventListener('DOMContentLoaded', function () {
  var playButtons = document.querySelectorAll('.about-video__play-btn'),
