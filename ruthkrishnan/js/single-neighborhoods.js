/******/ ;(() => {
  ...
  \********************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ USDFormatterDec: () =>
            /* binding */ USDFormatterDec,
          /* harmony export */ USDFormatterNoDec: () =>
            /* binding */ USDFormatterNoDec
          /* harmony export */
        })
        ...
        var mapZoom = function mapZoom() {
          var zoomInBtn = document.getElementById('map-neighborhoods__zoom-in'),
            ...
            container = Array.from(
              document.getElementsByClassName('map-neighborhoods__icon')
            )[0],
          ...
          function handleZoom(control) {
            if (control === 'increase') {
              ...
              if (width < 1500)
                container.style.width = ''.concat(width + 150, 'px')
            } else {
  ...
  \******************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__)
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ neighborhoodCharts: () =>
            /* binding */ neighborhoodCharts
          /* harmony export */
        })
        ...
        var neighborhoodCharts = function neighborhoodCharts() {
          ...
          var ctx = document
            .getElementById('neighborhoodChart')
            .getContext('2d')
          ...
          var filtersArr = document.querySelectorAll(
          ...
          var chartSwitch = function chartSwitch(evt) {
            ...
            if (currentData != value) {
              ...
              if (value === 'Sale to List Price Ratio') {
                ...
                barChart.config.options.scales.yAxes[0].ticks.callback =
                  twoDecYLabel
  ...
  \**********************************************************/
      /***/ (
        ...
        var dataTable = function dataTable() {
          var neighborhoodDataTable = document.getElementById(
          ...
          var data = [
            ...
            salePriceToSqFt,
            saleToListPrice,
            daysOnMarketMedian // competeScore,
          ]
          var USDFormatterNoDec = new Intl.NumberFormat('en-US', {
            style: 'currency',
            currency: 'USD',
          ...
          residenceType.result.grouping.groups.forEach(function (year) {
            ...
            daysOnMarketMedian.push(
              year.measurements.daysOnMarket.average.toFixed(0)
            )
            salePriceToSqFt.push(
              USDFormatterDec.format(
                year.measurements.salePrice.average /
                  year.measurements.size.average
              ) + '/sq.ft'
            )
        ...
        var photoGallery = function photoGallery() {
          if (document.querySelector('.photo-gallery__slider')) {
            ...
            var slider = document.querySelector('.photo-gallery__slider'),
              ...
              numpagination = document.querySelector(
                '.photo-gallery__numpagination'
              ),
            ...
            var setSlide = function setSlide() {
              ...
              if (numpagination) {
                paginationContent = ''
                  .concat(currSlide + 1, ' / ')
                  .concat(+numpagination.dataset.slides)
  ...
  \*******************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__)
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ sliderNeighborhoods: () =>
            /* binding */ sliderNeighborhoods
          /* harmony export */
        })
        /* harmony import */ var _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./USDFormat.js */ './src/scripts/resources/USDFormat.js'
          )
        /* harmony import */ var _resources_map_icon__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../resources/map-icon */ './src/scripts/resources/map-icon.js'
          )
        ...
        var sliderNeighborhoods = function sliderNeighborhoods() {
          ...
          var slides = Array.from(
            ...
            slideWrapper = document.querySelector(
            ...
            tooltipContainer = document.querySelector(
          ...
          allSlides.forEach(function (slide) {
            slide.elem.querySelector('[id^="transit-score-"]').innerHTML =
              slide.transitscore
            slide.elem.querySelector('[id^="walk-score-"]').innerHTML =
              slide.walkscore // slide.elem.querySelector('[id^="weather-score-"]').innerHTML = slide.weather
            ...
            if (slide.HJICondoMonthly || slide.HJISingleMonthly) {
              if (
                ...
                slide.elem.querySelector('#house-display').innerHTML =
                  '<b>no house data available for the last 6 months</b>' // slide.elem.querySelector('#house-display').innerHTML = "no house data available for the last 6 months"
              } else {
                slide.elem.querySelector(
                  '[id^="single-median-price-display-"]'
                ).innerHTML =
                  _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterNoDec.format(
                    slide.HJISingleMonthly.result.measurements.salePrice.median
                  )
                slide.elem.querySelector(
                  '[id^="single-sq-ft-price-display-"]'
                ).innerHTML =
                  _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterDec.format(
                    slide.HJISingleMonthly.result.measurements.salePrice
                      .median /
                      slide.HJISingleMonthly.result.measurements.size.median
                  )
              }
              ...
              if (
                ...
                slide.elem.querySelector('#condo-display').innerHTML =
                  '<b>no condo data available for the last 6 months</b>'
              } else {
                slide.elem.querySelector(
                  '[id^="condo-median-price-display-"]'
                ).innerHTML =
                  _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterNoDec.format(
                    slide.HJICondoMonthly.result.measurements.salePrice.median
                  )
                slide.elem.querySelector(
                  '[id^="condo-sq-ft-price-display-"]'
                ).innerHTML =
                  _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterDec.format(
                    slide.HJICondoMonthly.result.measurements.salePrice.median /
                      slide.HJICondoMonthly.result.measurements.size.median
                  )
              }
            }
          ...
          var slidesArr = allSlides.filter(function (slide) {
            return (
              slide.category === 'active' || slide.category === 'coming-soon'
            )
          })
          ...
          var setSlide = function setSlide(el, pos) {
            ...
            paginationIndicator.style.width = ''.concat(
              (pos / slidesArr.length) * 100,
              '%'
            )
          ...
          var activateNeighborhoodOpacity =
            function activateNeighborhoodOpacity(el) {
          ...
          var openTooltip = function openTooltip(event, el) {
            ...
            if (!sectionActive) {
              ...
              mapContent +=
                "<div class='map-neighborhoods__tooltip-title'>".concat(
                  targetEl.name,
                  '</div>'
              ...
              if (targetEl.HJICondoMonthly) {
                if (targetEl.HJICondoMonthly.result.measurements) {
                  ...
                  if (
                    targetEl.HJISingleMonthly.result.measurements.salePrice
                      .median != 0
                  ) {
                    mapContent +=
                      "<div class='map-neighborhoods__tooltip-info'>House Median Price: "
                        .concat(
                          _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterNoDec.format(
                            targetEl.HJISingleMonthly.result.measurements
                              .salePrice.median
                          ),
                          '<br> Median $/SqFt: '
                        )
                        .concat(
                          _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterDec.format(
                            targetEl.HJISingleMonthly.result.measurements
                              .salePrice.median /
                              targetEl.HJISingleMonthly.result.measurements.size
                                .median
                          ),
                          '/sf</div>'
                        )
                  ...
                  if (
                    targetEl.HJICondoMonthly.result.measurements.salePrice
                      .median != 0
                  )
                    mapContent +=
                      "<div class='map-neighborhoods__tooltip-info'>2BR/2BA Condo Median Price: "
                        .concat(
                          _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterNoDec.format(
                            targetEl.HJICondoMonthly.result.measurements
                              .salePrice.median
                          ),
                          '<br> Median $/SqFt: '
                        )
                        .concat(
                          _USDFormat_js__WEBPACK_IMPORTED_MODULE_0__.USDFormatterDec.format(
                            targetEl.HJICondoMonthly.result.measurements
                              .salePrice.median /
                              targetEl.HJICondoMonthly.result.measurements.size
                                .median
                          ),
                          '/sf</div>'
                        )
              ...
              if (event.clientY - 110 < tooltipContainer.clientHeight + 32) {
                ...
                tooltipContainer.style.top = ''.concat(
              ...
              if (window.innerWidth < 601) {
                ...
                tooltipContainer.style.left = ''.concat(
          ...
          var toNextSlide = function toNextSlide() {
            var currElem = document.querySelector(
          ...
          allSlides.forEach(function (slide) {
            if (slide.HJISingleMonthly.result) {
              if (
                slide.HJISingleMonthly.result.measurements.salePrice.median != 0
              ) {
                if (
                  slide.HJISingleMonthly.result.measurements.salePrice.median <
                  minMedianSingle
            ...
            if (slide.HJICondoMonthly.result) {
              if (
                slide.HJICondoMonthly.result.measurements.salePrice.median != 0
              ) {
                if (
                  slide.HJICondoMonthly.result.measurements.salePrice.median <
                  minMedianCondo
          ...
          function updateLegendGradientScale(
            legend,
            startColor,
            endColor,
            min,
            ...
            legend.innerHTML =
              '<div class="slider-neighborhoods__legend-content">\n    <div style="background:linear-gradient(90deg, '
                ...
                .concat(
                  endColor,
                  ' 100%" class="slider-neighborhoods__legend-box">\n    </div>\n    <div class="slider-neighborhoods__legend-text-container">\n    <p class="slider-neighborhoods__legend-text">'
                )
                .concat(
                  min,
                  '</p>\n    <p class="slider-neighborhoods__legend-text">'
          ...
          function updateLegendPunctuatedScale(legend, palletteArr) {
            var legendTemplate =
              '<div id="weather-see-more" class="listings-single__features-see-more"><span id="see-more-text" class="listings-single__features-see-more-btn">show legend</span></div>\n    <div id="weather-content" class="slider-neighborhoods__legend-content slider-neighborhoods__legend-content--punctuated">'
            weatherValues.forEach(function (weather, i) {
              legendTemplate +=
                '\n      <div style="display: flex; gap: 1rem; flex-direction: column;" class="slider-neighborhoods__legend-box-container">\n        <p>'
                  ...
                  .concat(
                    weather.weatherGroup[0].color,
                    '; min-width: 2rem; min-height: 2rem;" class="slider-neighborhoods__legend-box--filled"></div>\n        <p style="padding-left: 0.5rem;" class="slider-neighborhoods__legend-text">'
                  )
                  .concat(
                    weather.weatherGroup[0].fogWind,
                    '</p>\n      </div>\n      <div class="slider-neighborhoods__legend-boxes-container">\n          <div style="background: '
                  )
                  .concat(
                    weather.weatherGroup[1].color,
                    '; min-width: 2rem; min-height: 2rem;" class="slider-neighborhoods__legend-box--filled"></div>\n          <p style="padding-left: 0.5rem;"class="slider-neighborhoods__legend-text">'
                  )
                  .concat(
                    weather.weatherGroup[1].fogWind,
                    '</p>\n      </div>\n    </div>'
                  )
            })
            legendTemplate += '</div>'
          ...
          function colorIconArr(value) {
                ...
                if (icon.dataset.name == slide.neighborhood) {
                  ...
                  if (
                    ...
                    domain =
                      slide.HJISingleMonthly.result.measurements.salePrice
                        .median
                    color = 'hsl(0, 41%, '.concat(
                      Math.abs(scaleRange(domain, min, max) * 50 - 50),
                      '%)'
                    )
            ...
            function styleIcon(icon, backgroundColor) {
              ...
              var iconBackgrounds = Array.from(icon.children).filter(function (
                HTMLObjectElement
              ) {
          ...
          filtersArr.forEach(function (el) {
            el.addEventListener('click', function () {
              if (
                !el.classList.contains('slider-neighborhoods__filter--active')
              ) {
                document
      ...
      /***/ (
        ...
        var testimonials = function testimonials() {
          if (document.querySelector('.testimonials-section')) {
            var imageSlide = document.querySelectorAll(
                '.testimonials-section__image-slide'
              ),
              contentSlide = document.querySelectorAll(
                '.testimonials-section__content-slide'
              ),
              sliderLength = document.querySelector(
                '.testimonials-section__images-slider'
              ).dataset.imageSliderLength,
              dot = document.querySelectorAll('.testimonials-section__dot'),
              content = Array.from(
                document.querySelectorAll('.testimonials-section__content')
              ),
            ...
            var setSlide = function setSlide() {
              imageSlide.forEach(function (image) {
                currSlide === +image.dataset.imageIndex - 1
                  ? image.classList.add(
              ...
              contentSlide.forEach(function (content) {
                currSlide === +content.dataset.contentIndex - 1
  ...
  \***************************************************/
    __webpack_require__.r(__webpack_exports__)
    /* harmony import */ var _resources_neighborhood_data_table__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(
        /*! ../resources/neighborhood-data-table */ './src/scripts/resources/neighborhood-data-table.js'
      )
    /* harmony import */ var _resources_photo_gallery__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ../resources/photo-gallery */ './src/scripts/resources/photo-gallery.js'
      )
    /* harmony import */ var _resources_neighborhood_charts__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ../resources/neighborhood-charts */ './src/scripts/resources/neighborhood-charts.js'
      )
    /* harmony import */ var _resources_slider_neighborhoods__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(
        /*! ../resources/slider-neighborhoods */ './src/scripts/resources/slider-neighborhoods.js'
      )
    /* harmony import */ var _resources_testimonials__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(
        /*! ../resources/testimonials */ './src/scripts/resources/testimonials.js'
      )
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      ;(0,
      _resources_slider_neighborhoods__WEBPACK_IMPORTED_MODULE_3__.sliderNeighborhoods)() // END Imported Scripts -------------------
