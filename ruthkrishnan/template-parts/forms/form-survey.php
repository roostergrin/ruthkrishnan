    ...
    <?php if ( have_rows('get_in_touch') ) :
      ...
      ?>
        ...
        <div class="form-survey__container">
          <div class="form-survey__info">
            <h2 class="form-survey__title"><?php echo $title; ?></h2>
            <div class="form-survey__text"><?php echo $text; ?></div>
            <div class="form-survey__phone">
              <a href="<?php echo get_field('phone_link', 'options') ?>" class="form-survey__phone-link">
                <?php echo get_field('phone_number', 'options'); ?>
              </a>
            </div>
            <div class="form-survey__calbre">CalBRE# <?php echo get_field('calbre', 'options'); ?></div>
            <div class="form-survey__email">
              <a href="mailto:<?php echo get_field('email_address', 'options'); ?>" class="form-survey__email-link">
                <?php echo get_field('email_address', 'options'); ?>
              </a>
            </div>
            <div class="form-survey__address">
              <a href="<?php echo get_field('address_link', 'options'); ?>" class="form-survey__address-link" aria-label="Go to <?php echo get_field('address_aria', 'options'); ?> on Google Maps, opens in new tab">
            ...
            <div class="form-survey__form-container">
              <form action="" class="form-survey__form" id="survey-form" data-page='<?php echo the_title(); ?>'>
                ...
                <div class="form-survey__form-group">
                  ...
                  <select name="buying" id="buying" placeholder="Select one *" class="form-survey__input">
                ...
                <div class="form-survey__form-group">
                  ...
                  <select name="timeframe" id="timeframe" placeholder="Select one *" class="form-survey__input">
                ...
                <div class="form-survey__form-group">
                  ...
                  <select name="lenders" id="lenders" placeholder="Select one *" class="form-survey__input">
                ...
                <div class="form-survey__form-group">
                  ...
                  <select name="budget" id="budget" placeholder="Select one *" class="form-survey__input">
                ...
                <div class="form-survey__form-group">
                  ...
                  <textarea name="location" id="location" rows="5" class="form-survey__textarea" aria-label="message edit text"></textarea>
                </div>
