            ...
            <div class="form-survey__form-container">
              <form action="" class="form-survey__form" id="agent-referral-form" data-page='<?php echo the_title(); ?>'>
                ...
                <div id="buyer-form" class="form-survey__buyer">
                  <div class="form-survey__form-group">
                    <label for="homestyle" >Please enter your desired number of bedrooms, bathrooms, and approximate square footage.</label>
                    <input type="text" name="homestyle" id="homestyle" placeholder="What kind of home are you looking to buy?" class="form-survey__input">
                    <small class="form-survey__validation-message" id="homestyle">Please enter valid full name.</small>
                  </div>

                  <div class="form-survey__form-group">
                    <label for="neighborhoods" >Please enter the cities and/or neighborhoods where you would like to purchase a home.</label>
                    <input type="text" name="neighborhoods" id="neighborhoods" placeholder="Where are you looking to buy?" class="form-survey__input">
                    <small class="form-survey__validation-message" id="neighborhoods">Please enter valid full name.</small>
                  </div>
                  ...
                  <div class="form-survey__form-group form-survey__form-group--radio">
                    ...
                    <div class="form-survey__radio">
                      <div class="form-survey__radio--group">
                        <input type="radio" name="mortgage" id="yes_mortgage" value="yes">
                        <label for="yes_mortgage" class="form-survey__label--radio">yes</label>
                      </div>
                      <div class="form-survey__radio--group">
                        <input type="radio" name="mortgage" id="no_mortgage" value="no" checked>
                        <label for="no_mortgage" class="form-survey__label--radio">no</label>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-survey__form-group form-survey__form-group--radio">
                    ...
                    <div class="form-survey__radio">
                      <div class="form-survey__radio--group">
                        <input type="radio" name="timeline" id="zero" value="0-3 mos" checked>
                        <label for="zero" class="form-survey__label--radio">0-3 mos</label>
                      </div>
                      <div class="form-survey__radio--group">
                        <input type="radio" name="timeline" id="three" value="3-6 mos">
                        <label for="three" class="form-survey__label--radio">3-6 mos</label>
                      </div>
                      <div class="form-survey__radio--group">
                        <input type="radio" name="timeline" id="six" value="6-12 mos">
                        <label for="six" class="form-survey__label--radio">6-12 mos</label>
                      </div>
                      <div class="form-survey__radio--group">
                        <input type="radio" name="timeline" id="over" value="over 1 year">
                ...
                <div id="seller-form" class="form-survey__seller">
                  <div class="form-survey__form-group">
                    <label for="homestyle" class="form-survey__label">How soon are you planning to sell?</label>
                    <input type="text" name="homestyle" id="homestyle" placeholder="How soon are you planning to sell?" class="form-survey__input">
                    <small class="form-survey__validation-message" id="homestyle">Please enter valid full name.</small>
                  </div>
                  ...
                  <div class="form-survey__form-group">
                    <label for="homestyle" class="form-survey__label">Enter your name and property address</label>
                    <input type="text" name="homestyle" id="homestyle" placeholder="Enter your name and property address" class="form-survey__input">
                    <small class="form-survey__validation-message" id="homestyle">Please enter valid full name.</small>
                  </div>
