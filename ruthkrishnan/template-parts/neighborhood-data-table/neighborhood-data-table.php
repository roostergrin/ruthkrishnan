...
<?php if (!empty(get_field('single_yearly'))) : ?>
  <div id="neighborhood-data-table" class="neighborhood-data-table Home">
    ...
    <div class="neighborhood-data-table__container">
      ...
      <div class="neighborhood-data-table__toggle-container">
        <button id='homeToggle' class="neighborhood-data-table__toggle neighborhood-data-table__toggle--active">home sales</button>
        <button id='condoToggle' class="neighborhood-data-table__toggle">condo sales</button>
      </div>
      <!-- regarding tables I think this is messed up at the turn of the year and the months -->
      <div class="neighborhood-data-table__wrapper">
        ...
        <div id="condo" class="neighborhood-data-table__table--hidden"></div>
      </div>
    </div>
  </div>
<?php endif; ?>
